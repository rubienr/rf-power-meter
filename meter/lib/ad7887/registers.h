 ...
 * - LSB of ControlRegister corresponds to MSB of transmission to AT7887
 * - MSB of ControlRegister corresponds to LSB of transmission to AT7887
 * - LSB of ControlRegister is transmitted first, MSB last.
 */
...
union TransmissionData
{
    ...
    ControlRegister asControlRegister;
    uint8_t asUint8;
    uint16_t asUint16;
};
